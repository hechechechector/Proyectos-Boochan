...
## S4.1: Implementación Profesional del Túnel
...
## 🤖 S4.2: Configuración de Accesos y Aplicaciones

<div style="float: right; margin-right: 100px; margin-left: 20px; margin-top: 30px; pointer-events: none;"> <img src="drstrange.gif" style="width: 200px;"> </div>
...
<div style="float: right; margin-right: 20px; margin-left: 20px; margin-top: 30px; pointer-events: none;"> <img src="portaltft.gif" style="width: 150px;"> </div>

## 🔍 S4.3: Conexión web y SSH
